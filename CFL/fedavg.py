...
from CFL.ResNet import ResNet18
...
class Server:
    ...
    def train(self, communication_rounds=10, local_epochs=1, client_frac=0.4):
        ...
        for r in range(communication_rounds):
            ...
            downlink_bytes = len(selected_clients) * self.model_size_bytes
            uplink_bytes = len(selected_clients) * self.model_size_bytes
        ...
        self.save_detailed_history_to_txt(self.history, "federated_cifar10Res-10.txt")
